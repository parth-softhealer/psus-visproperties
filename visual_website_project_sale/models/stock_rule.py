...
class StockRule(models.Model):
    ...
    def _run_buy(self, procurements):
        ...
        for procurement, rule in procurements:
            ...
            # PSUS custom modification start
            if 'group_id' in procurement.values:
                group_id = procurement.values.get('group_id')
                sale_id = group_id and group_id[0].sale_id
                partner = sale_id and sale_id.photographer_id and sale_id.photographer_id.partner_id or partner
